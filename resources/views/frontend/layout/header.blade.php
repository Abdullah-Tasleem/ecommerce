...
<!-- Mirrored from gramentheme.com/html/addina/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 01 Jul 2025 21:09:13 GMT -->
                ...
                <div class="offcanvas__content">
                    <div class="offcanvas__top mb-40 d-flex justify-content-between align-items-center">
                        <div class="offcanvas__logo">
                            <a href="index.html">
                                <img src="{{ asset('assets/imgs/furniture/logo/logo-light.svg') }}"
                                    alt="logo not found">
                            </a>
                        </div>
                        ...
                        <div class="tp-header-top-menu d-flex align-items-center justify-content-end">
                            ...
                            <div class="header-lang-item tp-header-setting">
                                <span class="header-setting-toggle text-white"
                                    id="header-setting-toggle">Setting</span>
                                <ul>
                                    {{-- <li>
                                        <a class="furniture-clr-hover" href="#">My Profile</a>
                                    </li> --}}
                                    <li>
                                        <a class="furniture-clr-hover" href="{{ route('cart.index') }}">Cart</a>
                                    </li>
                                    @auth
                                        <li>
                                            <a class="furniture-clr-hover" href="{{ route('logout') }}"
                        ...
                        <div class="header-main-4">
                            <div class="header-left">
                                <div class="header-logo">
                                    <a href="{{ route('home') }}">
                                        <img src="{{ asset('assets/imgs/furniture/logo/logo.svg') }}"
                                            alt="logo not found">
                                    </a>
                                </div>
                                    ...
                                    <div class="main-menu">
                                        <nav id="mobile-menu">
                                            <ul>
                                                ...
                                                <li class="has-dropdown">
                                                    <a href="{{ route('show_products') }}">Shop</a>
                                                </li>
                                                <li class="has-dropdown">
                            ...
                            <div class="header-right d-inline-flex align-items-center justify-content-end">
                                <div class="header-search d-none d-xxl-block position-relative">
                                    ...
                                    <div id="search-dropdown" class="dropdown-menu w-100 mt-1 d-none"></div>
                                </div>
                                ...
                                <div class="header-action d-flex align-items-center ml-30">
                                    <div class="header-action-item">
                                        <a href="{{ route('login') }}" class="header-action-btn fs-1"
                                            title="Login">
